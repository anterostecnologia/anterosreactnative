...
import {AnterosParsedText} from '../Text/AnterosParsedText';
import Communications from 'react-native-communications';

const WWW_URL_PATTERN = /^www\./i;

export default class AnterosMessageText extends React.Component {
...
AnterosMessageText.contextTypes = {
  actionSheet: PropTypes.func,
};

AnterosMessageText.defaultProps = {
  position: 'left',
  currentMessage: {
    text: '',
  },
