...
import { isSameUser, isSameDay } from './AnterosUtilsChat';

export default class AnterosMessageChat extends React.Component {
  ...
  renderSystemMessage() {
    ...
    return <AnterosSystemMessage {...systemMessageProps} />;
  }
...
AnterosMessageChat.defaultProps = {
