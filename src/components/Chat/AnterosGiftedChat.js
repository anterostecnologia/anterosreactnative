...
import * as utils from './AnterosUtilsChat';
import Actions from './AnterosActionsChat';
import Avatar from './AnterosAvatarChat';
import Bubble from './AnterosBubbleChat';
import SystemMessage from './AnterosSystemMessage';
import MessageImage from './AnterosMessageImage';
import MessageText from './AnterosMessageText';
import Composer from './AnterosComposerChat';
import Day from './AnterosDayChat';
import InputToolbar from './AnterosInputToolbar';
import LoadEarlier from './AnterosLoadEarlier';
import Message from './AnterosMessageChat';
import MessageContainer from './AnterosMessageContainer';
import Send from './AnterosSendMessage';
import Time from './AnterosTimeChat';
import GiftedAvatar from './AnterosGiftedAvatar';
...
import {
  ...
  TIME_FORMAT,
  DATE_FORMAT,
} from './AnterosConstantChat';

class AnterosGiftedChat extends React.Component {
  ...
  render() {
    ...
    return (
      <View style={[styles.container, this.props.style]} onLayout={this.onInitialLayoutViewLayout}>
        {this.renderLoading()}
      </View>
    );
  }
...
AnterosGiftedChat.childContextTypes = {
  actionSheet: PropTypes.func,
  getLocale: PropTypes.func,
};

AnterosGiftedChat.defaultProps = {
  messages: [],
  text: undefined,
...
export {
  AnterosGiftedChat,
  Actions as AnterosActionsChat,
  Avatar as AnterosAvatarChat,
  Bubble as AnterosBubbleChat,
  SystemMessage as AnterosSystemMessage,
  MessageImage as AnterosMessageImage,
  MessageText as AnterosMessageText,
  Composer as AnterosComposerChat,
  Day as AnterosDayChat,
  InputToolbar as AnterosInputToolbar,
  LoadEarlier as AnterosLoadEarlier,
  Message as AnterosMessage,
  MessageContainer as AnterosMessageContainer,
  Send as AnterosSendChat,
  Time as AnterosTimeChat,
  GiftedAvatar as AnterosGiftedAvatar,
  utils as AnterosUtilsChat,
};
