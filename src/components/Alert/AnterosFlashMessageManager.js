...
/**
 * Non-public global class to handle the "default" AnterosFlashMessage instance to global use
 */
class AnterosFlashMessageManager {
...
export default new AnterosFlashMessageManager();