...
export class AnterosDropdownAlert extends Component {
  static propTypes = {
  ...
  static defaultProps = {
    ...
    messageNumOfLines: 3,
    imageSrc: null,
    infoImageSrc: require('../../assets/images/info.png'),
    warnImageSrc: require('../../assets/images/warn.png'),
    errorImageSrc: require('../../assets/images/error.png'),
    successImageSrc: require('../../assets/images/success.png'),
    cancelBtnImageSrc: require('../../assets/images/cancel.png'),
    infoColor: '#2B73B6',
    warnColor: '#cd853f',
    errorColor: '#cc3232',
    successColor: '#32A54A',
  ...
  renderTitle() {
    if (this.props.renderTitle) {
      ...
      return (
        <AnterosLabel style={StyleSheet.flatten(this.props.titleStyle)} numberOfLines={this.props.titleNumOfLines} text={this.state.title} />
      );
    }
  }
  renderMessage() {
    if (this.props.renderMessage) {
      ...
      return (
        <AnterosLabel style={StyleSheet.flatten(this.props.messageStyle)} numberOfLines={this.props.messageNumOfLines} text={this.state.message} />
      );
    }
  }
  render() {
