...
import {AnterosColorHueSlider} from './AnterosColorHueSlider';
import {AnterosColorSaturationSlider} from './AnterosColorSaturationSlider';
import {AnterosColorLightnessSlider} from './AnterosColorLightnessSlider';
...
export class AnterosColorPickerSliders extends Component {
  constructor(props) {
    super(props);
...
AnterosColorPickerSliders.propTypes = {
...
AnterosColorPickerSliders.defaultProps = {
  okLabel: 'Ok',
  cancelLabel: 'Cancel',
  value: '#70c1b3'
};