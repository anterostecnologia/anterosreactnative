...
import { AnterosFormField } from "../lib/AnterosFormField";
        ...
        >
          ...
          >
            ...
            <View style={this.props.valueContainerStyle}>
              <AnterosText style={this.props.valueStyle}>
...
AnterosPickerComponent.propTypes = {
  pickerWrapper: PropTypes.element
};

AnterosPickerComponent.defaultProps = {
  pickerWrapper: <View />
};
