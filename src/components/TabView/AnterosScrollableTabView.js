...
import {AnterosScrollableDefaultTabBar, AnterosScrollableTabBar} from './AnterosScrollableTabBar';
...
export const AnterosScrollableTabView = createReactClass({
  mixins: [TimerMixin, ],
  ...
  renderTabBar(props) {
    if (this.props.renderTabBar === false) {
      ...
      return <AnterosScrollableDefaultTabBar {...props} />;
    }
  },
...
export class AnterosScrollableTab extends PureComponent{
  constructor(props){
    super(props);
  }
  render(){
    return (<View tabLabel={this.props.tabLabel}>
              {this.props.children}
           </View>);
  }
}
