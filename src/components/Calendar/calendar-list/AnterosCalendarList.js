...
class AnterosCalendarList extends Component {
  static propTypes = {
  ...
  renderCalendar({item}) {
    return (<AnterosCalendarListItem item={item} calendarHeight={this.calendarHeight} calendarWidth={this.props.horizontal ? this.calendarWidth : undefined  } {...this.props} />);
  }
...
AnterosCalendarList.defaultProps = {
  calendarHeight: 360
};
