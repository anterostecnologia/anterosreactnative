...
export class AnterosMonthSelector extends Component {
  static propTypes = {
    ...
    return (
      ...
      >
        <TouchableOpacity onPress={() => this.handNextPrevTaps(false)}>
          {this.props.prevIcon ? this.props.prevIcon : (<AnterosText>Prev</AnterosText>)}
        </TouchableOpacity>
        <View style={styles.yearViewStyle}>
          <AnterosText style={[styles.yearTextStyle, this.props.yearTextStyle]}>
            {this.state.initialView.format('YYYY')}
          </AnterosText>
        </View>
        <TouchableOpacity onPress={() => this.handNextPrevTaps(true)}>
          {this.props.nextIcon ? this.props.nextIcon : (<AnterosText>Next</AnterosText>)}
        </TouchableOpacity>
      </View>
    );
  }
