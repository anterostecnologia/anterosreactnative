...
import Day from './day/basic/Day';
import UnitDay from './day/period/Day';
import MultiDotDay from './day/multi-dot/Day';
import SingleDay from './day/custom/Day';
import CalendarHeader from './header/AnterosCalendarHeader';
...
class AnterosCalendar extends Component {
  static propTypes = {
