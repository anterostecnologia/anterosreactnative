...
export class AnterosTimeline extends Component {
  ...
  _renderDetail(rowData, sectionID, rowID) {
    let title = rowData.description ? (
      <View>
        <AnterosText style={[styles.title, this.props.titleStyle]}>
          {rowData.title}
        </AnterosText>
        <AnterosText style={[styles.description, this.props.descriptionStyle]}>
          {rowData.description}
        </AnterosText>
      </View>
    ) : (
      <AnterosText style={[styles.title, this.props.titleStyle]}>{rowData.title}</AnterosText>
    );
