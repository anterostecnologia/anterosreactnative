...
export class AnterosCameraRollPicker extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    var listViewOrEmptyText = dataSource.getRowCount() > 0 ? (
      ...
      <AnterosText style={[{textAlign: 'center'}, emptyTextStyle]}>{emptyText}</AnterosText>
    );
...
AnterosCameraRollPicker.propTypes = {
...
AnterosCameraRollPicker.defaultProps = {
...
class ImageItem extends Component {
    ...
    render() {
      ...
      var marker = selectedMarker ? selectedMarker :
        <AnterosImage
          style={[stylesItem.marker, { width: 25, height: 25 }]}
