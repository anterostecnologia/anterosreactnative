...
export class AnterosPopover extends Component {
  ...
  buildProps() {
    ...
    style = [{
      backgroundColor: AnterosTheme.popoverColor,
      borderColor: AnterosTheme.popoverBorderColor,
      borderRadius: AnterosTheme.popoverBorderRadius,
      borderWidth: AnterosTheme.popoverBorderWidth,
    }].concat(style);
    ...
    let headerPaddingCorner = paddingCorner ? paddingCorner : AnterosTheme.popoverPaddingCorner;
