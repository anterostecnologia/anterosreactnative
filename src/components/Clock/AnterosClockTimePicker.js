...
const Colors = {
  ...
  const type = {
    base: Platform.OS === "ios" ? "Roboto" : "Roboto"
  };
...
export class AnterosClockTimePicker extends Component {
  constructor(props) {
    super(props);
      ...
      <View style={styles.container}>
        <View style={styles.topMenu}>
          <View style={styles.periodContainer}>
            ...
            >
              <View>
                <AnterosText style={this.getPeriodStyle("am")}>AM</AnterosText>
              </View>
            </TouchableWithoutFeedback>
            <TouchableWithoutFeedback
              hitSlop={{ top: 10, left: 10, bottom: 10, right: 10 }}
            ...
            >
              <View>
                <AnterosText style={this.getPeriodStyle("pm")}>PM</AnterosText>
              </View>
            </TouchableWithoutFeedback>
          </View>
...
AnterosClockTimePicker.propTypes = {
...
AnterosClockTimePicker.defaultProps = {
