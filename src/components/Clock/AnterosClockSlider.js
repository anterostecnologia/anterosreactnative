...
import Svg, { Circle, G, LinearGradient, Path, Defs, Stop, Text, Line } from 'react-native-svg';
...
export class AnterosClockSlider extends PureComponent {
  ...
  render() {
    ...
    return (
      <View style={{ width: containerWidth, height: containerWidth, borderColor: 'blue', borderWidth:2 }} onLayout={this.onLayout}>
        <Svg
