...
export class AnterosAnalogClock extends Component {
...
AnterosAnalogClock.defaultProps = {
  backgroundImage: require('../../assets/images/clockBack.png'),
  clockSize: 270,
  clockBorderWidth: 7,
  clockCentreSize: 15,
  clockCentreColor: '#2979FF',
  hourHandColor: '#0D47A1',
  hourHandCurved: true,
  hourHandLength: 70,
  hourHandWidth: 5.5,
  hourHandOffset: 0,
  minuteHandColor: '#0D47A1',
  minuteHandCurved: true,
  minuteHandLength: 100,
  minuteHandWidth: 5,
  minuteHandOffset: 0,
  secondHandColor: '#0D47A1',
