...
export class AnterosGrid extends Component {
  constructor(props) {
    super(props);
  ...
  getDimensions(lvDimension, itemDim) {
    ...
    if (itemWidth) {
      ...
      console.warn('Anteros Grid - property "itemWidth" is depreciated. Use "itemDimension" instead.');
    }
