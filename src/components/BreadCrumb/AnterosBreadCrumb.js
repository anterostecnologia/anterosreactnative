...
const AnterosCrumb = ({ isCrumbActive, index, text, firstCrumbStyle, lastCrumbStyle, crumbStyle, activeTabStyle, crumbTextStyle, activeCrumbTextStyle, activeCrumbStyle,
  ...
  return (
    <TouchableOpacity
      style={[
        styles.crumbStyle,
        crumbStyle,
        isCrumbActive ? [styles.activeCrumbStyle,activeCrumbStyle, activeTabStyle] : {},
        firstCrumbStyle,
        lastCrumbStyle,
        { height }]}
...
export const AnterosBreadCrumb = ({ flowDepth, entities, borderRadius, crumbsContainerStyle, crumbStyle, activeCrumbStyle, crumbTextStyle, activeCrumbTextStyle, onCrumbPress, isTouchable, height, triangleTailStyle, triangleHeadStyle
}) => {
  ...
  const triangleTailStyle1 = height ? { borderTopWidth: height / 2.0, borderBottomWidth: height / 2.0, borderLeftWidth: height / 2.0 } : {};
  const triangleHeadStyle1 = height ? { borderTopWidth: height / 2.0, borderBottomWidth: height / 2.0, borderLeftWidth: height / 2.0 } : {};
        ...
        entities.map((item, index) => {
          return (
            <AnterosCrumb
              ...
              triangleTailStyle={[triangleTailStyle1,triangleTailStyle]}
              triangleHeadStyle={[triangleHeadStyle1,triangleHeadStyle]}
            />
          );
        })
      }
...
AnterosBreadCrumb.propTypes = {
  ...
  triangleTailStyle: ViewPropTypes.style,
  triangleHeadStyle: ViewPropTypes.style,
