import React,{
  ...
  export class AnterosCircularActionMenu extends Component {
  ...
  AnterosCircularActionMenu.Item = ActionItem;
  
  AnterosCircularActionMenu.propTypes = {
  ...
  AnterosCircularActionMenu.defaultProps = {
    active: false,
    bgColor: 'transparent',
