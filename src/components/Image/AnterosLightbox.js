...
export class AnterosLightbox extends Component {
  static propTypes = {
  ...
  close = () => {
    throw new Error('AnterosLightbox.close method is deprecated. Use renderHeader(close) prop instead.')
  }
  ...
  render() {
    ...
    return (
      ...
      >
        ...
        {this.props.navigator ? false : <AnterosLightboxOverlay {...this.getOverlayProps()} />}
      </View>
    );
  }
}
...
export class AnterosLightboxOverlay extends Component {
  static propTypes = {
  ...
  render() {
    ...
    const openStyle = [stylesOverlay.open, {
    ...
    const header = (<Animated.View style={[stylesOverlay.header, lightboxOpacityStyle]}>{(renderHeader ?
      ...
      (
        <TouchableOpacity onPress={this.close}>
          <Text style={stylesOverlay.closeButton}>×</Text>
        </TouchableOpacity>
      )
    )}</Animated.View>);
    const content = (
