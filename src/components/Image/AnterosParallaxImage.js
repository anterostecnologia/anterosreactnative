...
import { View, ViewPropTypes, Image, Animated, Easing, StyleSheet, ActivityIndicator, findNodeHandle } from 'react-native';
import PropTypes from 'prop-types';


export class AnterosParallaxImage extends Component {
