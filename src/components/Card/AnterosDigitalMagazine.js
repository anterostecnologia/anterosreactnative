...
export class AnterosDigitalMagazine extends Component {
    constructor(props) {
        super(props);
...
this.height = height - 20;
    ...
    _renderRow(row) {
        ...
        return (
            <View style={{height: this.height, width, justifyContent: 'center', alignItems: 'center'}}>
                ...
                backgroundColor: 'white', height: 200, width: width - 32}}>
                    <Animated.View style={{flex: 1, opacity: this.state.text_opacity[page]}}>
                        ...
                        <View style={{padding: 24}}>
                            <Text style={{fontSize: 16, fontFamily:'dancingscript', fontStyle: 'italic'}}>
                                {author}
                            </Text>
                        </View>
