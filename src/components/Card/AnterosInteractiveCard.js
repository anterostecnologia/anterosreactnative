...
export class AnterosInteractiveCard extends Component {
...
export class DismissButton extends Component {
	...
	getImage() {
		if (this.props.imageSource) {
			...
			return require("../../assets/images/dismissBlue.png");
		}
	}
...
AnterosInteractiveCard.propTypes = {
	...
	children: function(prop, propName) {
		...
		if (numberOfChildren !== 2) {
			...
			const message = `Exactly 2 child components are expected inside \`AnterosInteractiveCard\` component, but ${whatWeGot}. It is recommended that you use the 'Header' and 'Content' components as the children for readability.`;
...
AnterosInteractiveCard.defaultProps = {
