...
import { View, Image, TouchableHighlight, FlatList, StyleSheet } from 'react-native';

import PropTypes from 'prop-types';
import AnterosMasonryBrick from './AnterosMasonryBrick';
...
export default class AnterosMasonryColumn extends Component {
	static propTypes = {
	...
	// _keyExtractor :: item -> id
	 ...
	 _keyExtractor(item) {
		if (this.props.columnKey){
		  return "IMAGE-KEY-" + item.uri + "---" + item[this.props.columnKey];   
		} else {
