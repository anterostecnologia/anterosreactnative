import { View, ListView, Image, Text, Dimensions, StyleSheet } from 'react-native';
import React, { Component } from 'react';
import PropTypes from 'prop-types';
import isEqual from 'lodash.isequal';
import differenceBy from 'lodash.differenceby';

import { resolveImage } from './AnterosMasonryModel';
import AnterosMasonryColumn from './AnterosMasonryColumn';
...
export default class AnterosMasonry extends Component {
	static propTypes = {
			...
			.map(resolveTask => resolveTask.fork(
				...
				(resolvedBrick) => {
					this.setState(state => {
						...
						const td = state.dataSource.cloneWithRows(sortedData);
