...
export class AnterosPercentageCircle extends Component {
    ...
    if (this.props.disabled) {
      return (
        <View style={[styles.circle,{
          ...
          <AnterosText style={styles.text}>{this.props.disabledText}</AnterosText>
        </View>
      );
    }
    return (
      <View style={[styles.circle,{
        ...
        <View style={[styles.innerCircle,{
          ...
          {this.props.children ? this.props.children :
            <AnterosText style={[styles.text, this.state.textStyle]}>{this.props.percent}%</AnterosText>}
        </View>
      </View>
    );
  }
