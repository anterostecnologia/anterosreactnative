...
class DefaultSlide extends PureComponent {
  render() {
    ...
    return (
      <View style={[stylesSlide.mainContent, style]}>
        <AnterosText style={[stylesSlide.title, this.props.titleStyle]}>{this.props.title}</AnterosText>
        <AnterosImage source={this.props.image} style={this.props.imageStyle} />
        <AnterosText style={[stylesSlide.text, this.props.textStyle]}>{this.props.text}</AnterosText>
      </View>
    );
  }
}
