...
import {makeArc, computeChartSum} from './util';

const CHART_GROW_ANIMATION_DURATION = 3000;
const SELECTED_SLICE_ANIMATION_DURATION = 750;

class AnterosARTChartDonut extends Component {
  constructor(props) {
    super(props);
    this.state = {
      t: 0,
    ...
    this._computeChartData = this._computeChartData.bind(this);
    this._initClickHandler = this._initClickHandler.bind(this);
    this._onLayout = this._onLayout.bind(this);
    this._initClickHandler = this._initClickHandler.bind(this);
    this._animateChart = this._animateChart.bind(this);
    this.donutSlices=[];
  }
