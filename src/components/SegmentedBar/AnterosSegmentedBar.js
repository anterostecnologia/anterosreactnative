...
export default class AnterosSegmentedBar extends Component {
  ...
  static Item = AnterosSegmentedItem;
  ...
  renderIndicator() {
    ...
    let style = {
      backgroundColor: indicatorLineColor ? indicatorLineColor : AnterosTheme.sbIndicatorLineColor,
      position: 'absolute',
      left: this._indicatorX,
      width: this._indicatorWidth,
      height: indicatorLineWidth || indicatorLineWidth === 0 ? indicatorLineWidth : AnterosTheme.sbIndicatorLineWidth,
    };
    if (this.props.indicatorPosition == 'top') {
      style.top = indicatorPositionPadding || indicatorPositionPadding === 0 ? indicatorPositionPadding : AnterosTheme.sbIndicatorPositionPadding;
    } else {
  ...
  renderFixed() {
    ...
    style = [{
      backgroundColor: AnterosTheme.sbColor,
      flexDirection: 'row',
    }].concat(style);
    if (!children) {
      children = [];
