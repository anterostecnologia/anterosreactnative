...
import {AnterosText, AnterosNavigationPage, AnterosClockSlider} from 'anteros-react-native';
...
class TimerText extends Component {
    ...
    render() {
      ...
      return (
        <View {...rest}>
          <View style={stylesText.timerContainer}>
            <AnterosText style={stylesText.time}>{hours}</AnterosText>
            <AnterosText style={stylesText.text}>HR</AnterosText>
            <AnterosText style={[stylesText.time, stylesText.span]}>{minutes}</AnterosText>
            <AnterosText style={stylesText.text}>MIN</AnterosText>
          </View>
        </View>
      );
    }
...
//               </Svg>
//               <AnterosText style={styles.bedtimeText}>Bedtime</AnterosText>
//             </View>
//             <AnterosText style={styles.timeValue}>{bedtime.h}:{padMinutes(bedtime.m)}</AnterosText>
//           </View>
//           <View style={styles.time}>
//             <View style={styles.timeHeader}>
//               <Svg height={16} width={16}>
...
//               </Svg>
//               <AnterosText style={styles.wakeText}>Wake</AnterosText>
//             </View>
//             <AnterosText style={styles.timeValue}>{waketime.h}:{padMinutes(waketime.m)}</AnterosText>
//           </View>
//         </View>
//         <View>
//           <TimerText
