...
export class NavigationBarExample extends AnterosNavigationPage {
  ...
  renderLeftRightView(item) {
    switch (item) {
      ...
      case 'Link button':
        return (<AnterosNavigationBar.LinkButton title='Link'/>);
      case 'Icon button':
        return (<AnterosNavigationBar.IconButton icon={require('../icons/search.png')}/>);
      case 'Two icon button':
        return (
          <View style={{
            flexDirection: 'row'
          }}>
            <AnterosNavigationBar.IconButton icon={require('../icons/edit.png')}/>
            <AnterosNavigationBar.IconButton icon={require('../icons/trash.png')}/>
          </View>
        );
    }
  }
  ...
  renderPage() {
    ...
    return (
      <ScrollView
        style={{
        flex: 1,
        paddingTop: AnterosTheme.statusBarHeight
      }}>
        <View
          style={{
        ...
        onValueChange = {
          value => this.setState({customBackground: value})
        } />}/>
        <AnterosListRow
          title='Hidden'
          detail={< Switch value = {
        ...
        onValueChange = {
          value => this.setState({hidden: value})
        } />}/>
        <AnterosListRow
          title='Animated'
          detail={< Switch value = {
        ...
        onValueChange = {
          value => this.setState({statusBarHidden: value})
        } />}
          bottomSeparator='full'/>
      </ScrollView>
    );
