...
import {AnterosNavigationPage, AnterosTheme, AnterosWheel} from 'anteros-react-native';

export default class WheelExample extends AnterosNavigationPage {
  ...
  renderPage() {
    ...
    return (
      <View style={{flex: 1}}>
        ...
        <View style={{backgroundColor: AnterosTheme.defaultColor, padding: 20, flexDirection: 'row', justifyContent: 'center'}}>
          <AnterosWheel
