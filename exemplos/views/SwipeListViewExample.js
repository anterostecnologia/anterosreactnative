...
import {AnterosText, AnterosNavigationPage, AnterosSwipeListView, AnterosSwipeRow} from 'anteros-react-native';

export default class SwipeListViewExample extends AnterosNavigationPage {
		...
		return (
			<View style={styles.container}>
				...
				<View style={styles.standalone}>
					...
					>
						<View style={styles.standaloneRowBack}>
							<AnterosText style={styles.backTextWhite}>Left</AnterosText>
							<AnterosText style={styles.backTextWhite}>Right</AnterosText>
						</View>
						<View style={styles.standaloneRowFront}>
							<AnterosText>I am a standalone AnterosSwipeRow</AnterosText>
						</View>
					</AnterosSwipeRow>
				</View>
				...
				<View style={styles.controls}>
					<View style={styles.switchContainer}>
						{ ['Basic', 'Advanced', 'FlatList', 'SectionList'].map( type => (
							...
							>
								<AnterosText>{type}</AnterosText>
							</TouchableOpacity>
						))}
					</View>
					{
						this.state.listType === 'Advanced' &&
						<AnterosText>(per row behavior)</AnterosText>
					}
				</View>
...

				{
					...
					<AnterosSwipeListView
						...
						renderItem={ (data, rowMap) => (
							...
							>
								<View>
									<AnterosText>I am {data.item.text} in a AnterosSwipeListView</AnterosText>
								</View>
							</TouchableHighlight>
						)}
...

				{
					...
					<AnterosText>Coming soon...</AnterosText>
				}
